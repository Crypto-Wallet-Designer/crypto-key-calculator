        ...
        <Card style={{ marginTop: '10px' }}>
          <Card.Body>
            <Alert style={{ marginBottom: '0px' }} variant="lavender" onClose={() => setShowSetKeysInfo(false)} dismissible>
              ...
              Can also automatically create a wallet (optimal with up to 6 keys; using simulated annealing with 7-12 keys), generate a smart contract and deploy to Ethereum.<br />
              You can then use our <a href="https://github.com/Crypto-Wallet-Designer/wallet-client-cli" style={{ color: '#E6E9FB' }}>CLI</a> to interact with the smart contract.<br />
